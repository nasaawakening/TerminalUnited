...
import com.terminalunited.shared.termux.terminal.io.BellHandler;
import com.terminalunited.shared.logger.Logger;
import com.terminalunited.terminal.TerminalColors;
import com.terminalunited.terminal.TerminalSession;
import com.terminalunited.terminal.TerminalSessionClient;
import com.terminalunited.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.terminalunited.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.terminalunited/com.terminalunited.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
